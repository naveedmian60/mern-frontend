  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center hover:bg-red-50 hover:text-red-500 transition-all"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          {/* LEFT - Image */}
          <div className="relative bg-gray-50 rounded-l-3xl overflow-hidden">
            {!imgError && product.image ? (
              ...
              <div className="w-full h-[300px] sm:h-[500px] flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50">
